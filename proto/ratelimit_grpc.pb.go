...
const (
	RateLimiter_Allow_FullMethodName = "/bucketd.v1.RateLimiter/Allow"
)
...
var RateLimiter_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bucketd.v1.RateLimiter",
